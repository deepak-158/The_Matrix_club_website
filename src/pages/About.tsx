...
const SPONSORS = [
  ...
  { name: 'Engineering Garage', logo: '/images/sponsors/engineeringgarage.jpg' },
  { name: 'Render', logo: '/images/sponsors/render.png' },
  { name: 'n8n', logo: '/images/sponsors/n8n.svg' },
  { name: '.XYZ', logo: '/images/sponsors/xyz.svg' },
]
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem', flexWrap: 'wrap' }}>
          <motion.div
            ...
            ><span>
              ...
              <span style={{textAlign: 'center'}}>Sam Bhagwat <br/>Founder and CEO at Mastra</span>
              <a href="https://www.linkedin.com/in/sambhagwat/" target='_blank'><img src="/images/linkedin.png" alt="LinkedIn" style={{width:40}}/></a>
            </motion.div>
        </div>
